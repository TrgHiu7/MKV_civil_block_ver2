...
HD_PWD='/home/tronghieu/vivado-workspace/HW/mkv/mkv.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Key_Expansion.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Key_Expansion.tcl -notrace
