...
namespace eval ::optrace {
  variable script "/home/tronghieu/vivado-workspace/HW/mkv/mkv/mkv.runs/synth_1/N_ROUND.tcl"
...
synth_design -top N_ROUND -part xc7a100tcsg324-1 -mode out_of_context
...
write_checkpoint -force -noxdef N_ROUND.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file N_ROUND_utilization_synth.rpt -pb N_ROUND_utilization_synth.pb"
